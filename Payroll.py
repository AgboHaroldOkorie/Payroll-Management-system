...
#from mysql.cnnector import error
#from PIL import Image, ImageTK
#from tkinter import ttk


payroll = Tk()
payroll.geometry("1366x790")
payroll.resizable(0, 0)
payroll.title(" ")


def Submit():
    Scode = random.randit(1200, 3467)
    Subm = ("Submit" + str(Scode))
    Submit.set(Subm)
...
#This function is to reset the whole system
def reset():
    EmployeeName.set("")
    Address.set("")
    Reference.set("")
...
#The function generates the payment refernce number
def PayRef():
...
lblTitle = Label(Tops, font=('arial', 46, 'bold'), text="GALAXY PAYROLL MANAGEMENT SYSTEM", fg="blue", bd=10, anchor="w")
lblTitle.grid(row=0, column=0)
localtime=time.asctime(time.localtime(time.time()))

lblInfo=Label(Tops,font=('helvetica',44,'bold'),text="PAYROLL MANAGEMENT",fg="Black",bd=10,anchor='w')
lblInfo.grid(row=0,column=0)


lblInfo=Label(Tops,font=('arial',30,'bold'),text=localtime,fg="blue",bd=10,anchor='w')
...
txtEmployeeName = Entry(InsideLF, font=('arial', 12, 'bold'), bd=20, width=54, bg="white", justify="left", textvariable = EmployeeName)
...
txtAddress = Entry(InsideLF, font=('arial', 12, 'bold'), bd=20, width=54, bg="white", justify="left", textvariable = Address)
...
txtReference = Entry(InsideLF, font=(' arial ', 12, 'bold'), bd=20, width=54, bg="white", justify="left", textvariable = Reference)
...
txtEmployerName = Entry(InsideLF, font=('arial', 12, 'bold'), bd=20, width=54, bg="white", justify="left", textvariable = EmployerName)
...
txtCity = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="right", textvariable = City)
...
txtBasic = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="right", textvariable = Basic)
...
txtOverTime = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="right", textvariable = OverTime)
...
lblGrossPay = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="right", textvariable = GrossPay)
...
lblNetPay = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="right", textvariable = NetPay)
...
txtTax = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="right", textvariable = Tax)
...
txtPension = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="right", textvariable = Pension)
...
txtStudenLoan = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="right", textvariable = StudenLoan)
...
txtNIPavment = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="right", textvariable = NIPayment)
...
txtDeducations = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="right", textvariable = Deducations)
...
txtPostCode = Entry(InsideRF, font=('arial', 12, 'bold'), bd=10, width=50, bg="white", justify="right", textvariable = PostCode)
...
txtGender = Entry(InsideRF, font=('arial', 12, 'bold'), bd=10, width=50, bg="white", justify="right", textvariable = Gender)
...
txtPayDate = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="left", textvariable = PayDate)
...
txtTaxPeriod = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="left", textvariable = TaxPeriod)
...
txtNINumber = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="left", textvariable = NINumber)
...
txtNICode = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="left", textvariable = NICode)
...
txtTaxablePay  = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="left", textvariable = TaxablePay)
...
txtPensionablePay = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="left", textvariable = PensionablePay)
...
txtOtherPaymentDue = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="white", justify="left", textvariable = OtherPaymentDue)
txtOtherPaymentDue.grid(row=6, column=1)

#----------------------

btnReset = Button(InsideRFR, padx=8, pady=8, fg="black", font=('arial', 12, 'bold'), width=14,
                        text="Reset Syst", bg="blue", command=reset).grid(row=1, column=0)



btnWagePayment = Button(InsideRFR, padx=8, pady=8, fg="black", font=('arial', 12, 'bold'), width=14,
                        text="Wage Paymant", bg="blue", command=MonthlySalary).grid(row=0, column=0)



btnPayRef = Button(InsideRFR, padx=8, pady=8, fg="black", font=('arial', 12, 'bold'), width=14,
                        text="Pay Reference", bg="blue", command=PayRef).grid(row=2, column=0)


btnPayCode = Button(InsideRFR, padx=8, pady=8, fg="black", font=('arial', 12, 'bold'), width=14,
                        text="Pay Code", bg="blue", command=PayPeriod).grid(row=3, column=0)



btnExit = Button(InsideRFR, padx=8, pady=8, fg="black", font=('arial', 12, 'bold'), width=14,
                        text="Exit", bg="blue", command=exit).grid(row=4, column=0)



"""
btnPayCode = Button(InsideRFR, padx=8, pady=8, fg="black", font=('arial', 12, 'bold'), width=14,
                        text="Submit", bg="blue", command=Submit).grid(row=3, column=0)
                        """
